...
Environment validation capability provides Zod-based schema validation for all environment variables with support for development/production mode differentiation.
