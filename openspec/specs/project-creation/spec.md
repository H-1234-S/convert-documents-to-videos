...
Project creation capability enables authenticated users to submit source text and trigger AI video generation. It provides idempotent project creation with daily quota enforcement, concurrent project limits, PostgreSQL advisory lock serialization, and Inngest event publishing for downstream pipeline processing.
