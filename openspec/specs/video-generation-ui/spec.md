# Video Generation UI Specification

## Purpose

Provides the core text-to-video input interface with centered layout, auto-expanding textarea, icon-based submit button, and fade mask.
