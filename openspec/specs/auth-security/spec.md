...
This capability defines security measures for authentication systems, including CSRF protection, rate limiting, secure cookie configuration, password hashing, and audit logging.
